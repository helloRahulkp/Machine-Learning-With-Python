...
# cluster the above dataset into a different number of clusters, say k=3. 
# Note the difference in the pattern generated
...
# This dataset is used to demonstrate clustering on real-world data.
# It contains customer data with various features.
cust_df = pd.read_csv("/media/rahulkp/HDD/Learning/IBM AI Engineering/Lab/Cust_Segmentation.csv")
print(cust_df.sample(5))
# Pre-processing
