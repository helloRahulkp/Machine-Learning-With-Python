...
# In this case we know how to scale the coordinates. Using standardization 
# would be an error becaues we aren't using the full range of the lat/lng coordinates.
...
# Assign the cluster labels to your unscaled 
# coordinate dataframe and display the counts of each cluster label
