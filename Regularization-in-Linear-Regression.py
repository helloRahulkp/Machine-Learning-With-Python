...
regression_results(y_test, y_pred_lasso, 'Lasso Regression')
...
# Choose a threshold value to select features based on the Lasso model coefficients
...
print(feature_importance_df[feature_importance_df['Feature Selected']].to_string())

print("\nNonzero Ideal Coefficient Indices")
print(feature_importance_df[feature_importance_df['Ideal Coefficient']>0].to_string())
...
print("Regression results on test set with Lasso-selected features:")
